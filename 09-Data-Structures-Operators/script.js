...
// 1.
console.log(footballEvents.values());
const events = [...new Set(footballEvents.values())];
console.log(events);

// 2.
footballEvents.delete(64);
console.log(footballEvents.values());

// 4.
const time_football = [...footballEvents.keys()].pop();
console.log(time_football);

// 3.
console.log(
  `An event happened, on average, every ${
    time_football / footballEvents.size
  } minutes`
);

// 4.
for (const [min, events] of footballEvents) {
